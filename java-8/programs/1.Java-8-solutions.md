...
public class SecondLargestNumber {
    public static void main(String[] args) {
        ...
        Optional<Integer> secondSmallest2 = numbers.stream()
                .distinct()
                .sorted()
                .limit(2)
...
public class OptionalExample {
    public static void main(String[] args) {
        ...
        /*
        User u1 -> [500001, 500002]
        User u2 -> [600001, 600002]
        */

       users.stream()
       .flatMap(user -> user.getAddresses().stream())
       .forEach(a -> System.out.println(a.getPinCode()));
       /*
       500001
       500002
       600001
